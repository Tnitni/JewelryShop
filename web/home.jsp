...
<html lang="en">
    ...
    <body>
        ...
        <div class="site-wrap">
            ...
            <div class="site-blocks-cover" style="background-image: url(images/Origin_460x.webp);" data-aos="fade">
                <div class="container">
                    <div class="row align-items-start align-items-md-center justify-content-end">
                        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                            <h1 class="mb-2" style="zoom: 120%; color: gainsboro">Finding Your Perfect Jewelry</h1>
                            <div class="intro-text text-center text-md-left">
                                <p class="mb-4" style="zoom: 120%; color: white; font-weight: bold">Welcome to My Jewelry! We believe that the right pair of Jewelry can not only improve your vision, but also express your unique personality and style. 
