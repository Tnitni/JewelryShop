                        ...
                        <div class=" row col-md-12 text-center">
                            ...
                            <%
                                ...
                                for (InvoiceDTO invoice : invoiceList) {
                                    if(invoice.getUserId().equals(loginUser.getUserId()&&)){
                            %>
                            <div class="col-md-6 mb-5 mb-md-0 text-center">
                                <h2 class="h3 mb-3 text-black text-left">Billing Details</h2>
                                <div class="p-3 p-lg-5 border">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="datetime-local" class="form-control" id="c_dateBuy" name="dateBuy" value="<%=invoice.getDateBuy()%>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="c_gmail" name="gmail"value="<%=invoice.getGmail()%>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="c_address" name="address" value="<%=invoice.getAddress()%>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="c_total" class="text-black">Total Prices <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="c_total" name="total" value="<%=invoice.getTotal()%>" readonly>
                                        </div>
                                    </div>
                                 <%}
}   %>
