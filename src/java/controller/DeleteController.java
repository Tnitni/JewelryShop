...
public class DeleteController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean checkDelete = dao.deleteJewelry(JewelryId);
            if (checkDelete) {
                url = SUCCESS;
                request.setAttribute("message", "Delete Jewelry successfully.");
            } else {
                request.setAttribute("message", "Delete fail!");
            }
        } catch (Exception e) {
            log("Error at DeleteJewelryController: " + e.toString());
        } finally {
